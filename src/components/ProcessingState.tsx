...
const ProcessingState: React.FC<ProcessingStateProps> = ({ steps, fileName }) => {
    ...
    <div className="max-w-2xl mx-auto animate-fade-in">
      ...
      <div className="text-center mb-12">
        <div className="flex justify-center mb-6">
          <div className="relative">
            ...
            <div className="absolute -top-1 -right-1 w-6 h-6 bg-success-500 rounded-full flex items-center justify-center">
              <span className="text-xs font-bold text-white">{completedSteps}</span>
            </div>
          </div>
        </div>
        ...
        <p className="text-neutral-600 mb-2">
          Processing: <span className="font-medium text-primary-900">{fileName}</span>
        </p>
