...
const ResultsDashboard: React.FC<ResultsDashboardProps> = ({ fileName }) => {
  const [activeTab, setActiveTab] = useState<'summary' | 'risks' | 'qa'>('summary');
    ...
    <div className="animate-fade-in">
      ...
      <div className="mb-8">
        ...
        <p className="text-neutral-600">
          Analysis of: <span className="font-medium text-primary-900">{fileName}</span>
        </p>
      </div>
